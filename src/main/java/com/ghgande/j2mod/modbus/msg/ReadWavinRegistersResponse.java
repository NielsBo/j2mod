 ...
 */
public class ReadWavinRegistersResponse extends ModbusResponse {
     ...
     */
    public ReadWavinRegistersResponse() {
        super();
        setFunctionCode(Modbus.READ_WAVIN);
    }
     ...
     */
    public ReadWavinRegistersResponse(Register[] registers) {
        super();
